...
// #define MAX_FORWARD 0.3
// #define MAX_LEFT 0.2
// #define MAX_TURN 2.0
// #define FORWARD_CHANGE 0.06
// #define LEFT_CHANGE 0.1
// #define TURN_CHANGE 1.0
...
std::tuple<geometry_msgs::msg::Twist, StepVariable> StepCalculator::calculateNext(
  ...
  const geometry_msgs::msg::Twist & target)
{
  ...
  return std::make_tuple(nextStepTarget, retSV);
}
