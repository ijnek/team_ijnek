...
private:
  nao_command_msgs::msg::JointPositions calculate_joints(motion_interfaces::msg::IKCommand & ik_command);
  ...
  rclcpp::Subscription<motion_interfaces::msg::IKCommand>::SharedPtr sub_ik_command;
